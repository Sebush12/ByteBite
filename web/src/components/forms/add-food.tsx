...
import {
  ...
  Heading, HStack,
  Input,
  InputGroup, InputRightElement, Link, Modal, ModalBody, ModalCloseButton, ModalContent, ModalOverlay,
  Stack,
  Text,
...
export const AddFoodItem: FC = () => {
  ...
  const handleCreate = async ({calories, carbs, fat, name, protein }:MutationCreateFoodItemArgs, { resetForm }:FormikHelpers<any> )  => {
